...
class LogEntry PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_raftRpcPro_2fraftRPC_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
class RequestVoteArgs PROTOBUF_FINAL :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 candidatedid() const;
  void set_candidatedid(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_candidatedid() const;
  void _internal_set_candidatedid(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::int32 term_;
  ::PROTOBUF_NAMESPACE_ID::int32 candidatedid_;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 RequestVoteArgs::_internal_candidatedid() const {
  return candidatedid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 RequestVoteArgs::candidatedid() const {
  // @@protoc_insertion_point(field_get:raftRpcProctoc.RequestVoteArgs.CandidatedId)
  return _internal_candidatedid();
}
inline void RequestVoteArgs::_internal_set_candidatedid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  candidatedid_ = value;
}
inline void RequestVoteArgs::set_candidatedid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_candidatedid(value);
  // @@protoc_insertion_point(field_set:raftRpcProctoc.RequestVoteArgs.CandidatedId)
}
