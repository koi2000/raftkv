...
// source: raftRpcPro/kvServerRPC.proto
...
static void InitDefaultsscc_info_GetArgs_raftRpcPro_2fkvServerRPC_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetArgs_raftRpcPro_2fkvServerRPC_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_GetArgs_raftRpcPro_2fkvServerRPC_2eproto}, {}};

static void InitDefaultsscc_info_GetReply_raftRpcPro_2fkvServerRPC_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetReply_raftRpcPro_2fkvServerRPC_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_GetReply_raftRpcPro_2fkvServerRPC_2eproto}, {}};

static void InitDefaultsscc_info_PutAppendArgs_raftRpcPro_2fkvServerRPC_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_PutAppendArgs_raftRpcPro_2fkvServerRPC_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_PutAppendArgs_raftRpcPro_2fkvServerRPC_2eproto}, {}};

static void InitDefaultsscc_info_PutAppendReply_raftRpcPro_2fkvServerRPC_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_PutAppendReply_raftRpcPro_2fkvServerRPC_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_PutAppendReply_raftRpcPro_2fkvServerRPC_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_raftRpcPro_2fkvServerRPC_2eproto[4];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_raftRpcPro_2fkvServerRPC_2eproto = nullptr;
static const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* file_level_service_descriptors_raftRpcPro_2fkvServerRPC_2eproto[1];

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_raftRpcPro_2fkvServerRPC_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::raftKVRpcProctoc::GetArgs, cliented_),
...
const char descriptor_table_protodef_raftRpcPro_2fkvServerRPC_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\034raftRpcPro/kvServerRPC.proto\022\020raftKVRp"
  "cProctoc\";\n\007GetArgs\022\013\n\003Key\030\001 \001(\014\022\020\n\010Clie"
  "nted\030\002 \001(\014\022\021\n\tRequestId\030\003 \001(\005\"&\n\010GetRepl"
  ...
  "vServerRpc\022N\n\tPutAppend\022\037.raftKVRpcProct"
  "oc.PutAppendArgs\032 .raftKVRpcProctoc.PutA"
  "ppendReply\022<\n\003Get\022\031.raftKVRpcProctoc.Get"
  "Args\032\032.raftKVRpcProctoc.GetReplyB\003\200\001\001b\006p"
  "roto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_raftRpcPro_2fkvServerRPC_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_raftRpcPro_2fkvServerRPC_2eproto_sccs[4] = {
  &scc_info_GetArgs_raftRpcPro_2fkvServerRPC_2eproto.base,
  &scc_info_GetReply_raftRpcPro_2fkvServerRPC_2eproto.base,
  &scc_info_PutAppendArgs_raftRpcPro_2fkvServerRPC_2eproto.base,
  &scc_info_PutAppendReply_raftRpcPro_2fkvServerRPC_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_raftRpcPro_2fkvServerRPC_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_raftRpcPro_2fkvServerRPC_2eproto = {
  false, false, descriptor_table_protodef_raftRpcPro_2fkvServerRPC_2eproto, "raftRpcPro/kvServerRPC.proto", 445,
  &descriptor_table_raftRpcPro_2fkvServerRPC_2eproto_once, descriptor_table_raftRpcPro_2fkvServerRPC_2eproto_sccs, descriptor_table_raftRpcPro_2fkvServerRPC_2eproto_deps, 4, 0,
  schemas, file_default_instances, TableStruct_raftRpcPro_2fkvServerRPC_2eproto::offsets,
  file_level_metadata_raftRpcPro_2fkvServerRPC_2eproto, 4, file_level_enum_descriptors_raftRpcPro_2fkvServerRPC_2eproto, file_level_service_descriptors_raftRpcPro_2fkvServerRPC_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_raftRpcPro_2fkvServerRPC_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_raftRpcPro_2fkvServerRPC_2eproto)), true);
namespace raftKVRpcProctoc {
...
GetArgs::GetArgs(const GetArgs& from)
  ...
  cliented_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_cliented().empty()) {
    cliented_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_cliented(),
      GetArena());
  }
...
void GetArgs::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetArgs_raftRpcPro_2fkvServerRPC_2eproto.base);
  key_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  cliented_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  requestid_ = 0;
}
...
void GetArgs::SharedDtor() {
  ...
  cliented_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
// @@protoc_insertion_point(message_clear_start:raftKVRpcProctoc.GetArgs)
  ...
  cliented_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  requestid_ = 0;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          auto str = _internal_mutable_cliented();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* GetArgs::_InternalSerialize(
  ...
  // bytes Cliented = 2;
  if (this->cliented().size() > 0) {
    target = stream->WriteBytesMaybeAliased(
        2, this->_internal_cliented(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:raftKVRpcProctoc.GetArgs)
  ...
  if (from.cliented().size() > 0) {
    _internal_set_cliented(from._internal_cliented());
  }
  if (from.requestid() != 0) {
...
void GetArgs::InternalSwap(GetArgs* other) {
  ...
  cliented_.Swap(&other->cliented_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
...
void GetReply::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetReply_raftRpcPro_2fkvServerRPC_2eproto.base);
  err_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  value_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
void PutAppendArgs::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_PutAppendArgs_raftRpcPro_2fkvServerRPC_2eproto.base);
  key_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  value_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  op_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  clientid_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void PutAppendReply::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_PutAppendReply_raftRpcPro_2fkvServerRPC_2eproto.base);
  err_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* kvServerRpc::descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_raftRpcPro_2fkvServerRPC_2eproto);
  return file_level_service_descriptors_raftRpcPro_2fkvServerRPC_2eproto[0];
}
...
void kvServerRpc::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
                             ...
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), file_level_service_descriptors_raftRpcPro_2fkvServerRPC_2eproto[0]);
  switch(method->index()) {
    case 0:
